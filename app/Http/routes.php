...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::group(['prefix' => 'setting'], function () {
	    ...
	    Route::delete('destroy/{id}', ['as' => 'SettingController.destroySetting', 'uses' => 'SettingController@destroy']);
	    ...
	    Route::delete('type/destroy/{id}', ['as' => 'SettingController.destroyType', 'uses' => 'SettingController@destroyType']);
	    ...
	    Route::delete('group/destroy/{id}', ['as' => 'SettingController.destroyGroup', 'uses' => 'SettingController@destroyGroup']);
