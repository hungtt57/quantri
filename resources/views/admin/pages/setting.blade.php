	...
	<div class="col-xs-12 no-padding-left no-padding-right">
		<div class="row">
			<div class="col-xs-12 col-sm-9 col-lg-10">
				<a class="btn btn-sm btn-primary" style="margin-top:5px"><i class="fa fa-plus" aria-hidden="true"></i> Thêm cài đặt</a>
				<a class="btn btn-sm btn-primary" style="margin-top:5px">Quản lý loại cài đặt</a>
				<a class="btn btn-sm btn-primary" style="margin-top:5px">Quản lý nhóm cài đặt</a>
			</div>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab_a">
						<form style="margin-top: 15px;">
							<div >
								<table id="settingList" class="display" cellspacing="0">
									<thead>
										<tr>
											<th></th>
											<th>#</th>
									...
									<tfoot>
										...
										<tbody>
											<tr>
												...
												<td>
													<textarea name="" class="form-control" placeholder="Value..." style="margin: 0px; overflow: hidden; word-wrap: break-word; resize: horizontal; height: 50px;width: 100%;" rows="1" cols="30" id="">false</textarea>
												</td>
											</tr>	
										</tbody>
								</table>
